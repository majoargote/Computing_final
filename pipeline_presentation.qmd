...
- Roles:
  - Setup owner: creates the structure, organizes team, and leads initial steps
  - Feature owner: implements and tests features
  - API owner: builds on functions from previous work and leads end to end API creation
- Communication and collaboration: emphasized commit messages, PR descriptions, and small focused PRs.
- We regrouped via WhatsApp to test code worked for each of us and tackle any rework as a team

---

## Contributions by team member

- **Maríajosé Argote**: initial setup, core pipeline and preprocessing, packaging, tests.
